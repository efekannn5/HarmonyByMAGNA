...
**İş Akışı:**
1. Grupları listele → Kullanıcı grup seçer
2. Grup içinde istediği EOL'ü seçer (sıralama zorunlu değil)
3. EOL dolly'lerini göster
4. İstediği zaman başka bir EOL'e geçebilir (aynı grup içinde)
