...
#### ✅ Senaryo 3: Manuel Toplama
```
1. GET /manual-collection/groups → Grup listesi
2. GET /manual-collection/groups/V710-MR-EOL → Dolly'leri getir
3. POST /manual-collection/scan → barcode: 5170427
4. POST /manual-collection/scan → barcode: 5170428
5. (Web operatör tamamlar)
```
