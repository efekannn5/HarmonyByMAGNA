...
### **1. dolly_order_no NULL geliyor**
```json
// ŞU AN (YANLIŞ):
{
  "dolly_no": "1070744",
  "dolly_order_no": null,  ← NULL GELIYOR!
  "vin_no": "TANRTL77984\nTANXTL79360",
  "scanned": false
}
...
{
  "dolly_no": "1070744",
  "dolly_order_no": "1",  ← DOLU OLMALI!
  "vin_no": "TANRTL77984\nTANXTL79360",
  "scanned": false
}
```

**Sonuç:** Mobil'de dolly sıraları görünmüyor ("SEQ-???")

---

### **2. Grup adı/EOL adı karışıklığı**
```
...
**Sorun:** Backend EOL adını grup adı olarak kullanıyor gibi görünüyor.

**Olması gereken:**
- Grup adı: "710grup" (asıl grup)
- EOL adı: "V710-LLS-EOL" (EOL istasyonu)
...
Backend düzelene kadar mobil uygulamada **geçici** çözüm uygulandı:
...
**Not:** Backend grup yapısını düzelttikten sonra mobil uygulamada bu geçici fix kaldırılacak.
...
### **Öncelik 1: ACİL**
- [ ] `dolly_order_no` field'ını doldur (NULL olmasın)
- [ ] Grup adı/EOL adı ayrımını düzelt
- [ ] Request validation'ı düzelt (`group_name` ≠ `eol_name`)

### **Öncelik 2: ÖNEMLI**
- [ ] Dolly sırası kontrolünü sadece **aynı EOL içinde** yap
- [ ] Farklı EOL geçişlerine izin ver (aynı grup ise)
- [ ] Error response'lara detay ekle (`expected_dolly`, `received_dolly`)
...
**Durum:** 🔴 Backend düzeltmesi bekleniyor
